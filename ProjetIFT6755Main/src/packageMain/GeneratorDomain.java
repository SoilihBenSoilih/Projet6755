...
public class GeneratorDomain {
	...
	public static String locking="", waiting="",washing="",drying="",unlocking="";
	public static String startPrewash="",startWash="",endPrewash="",endWash="",startDrying="",endDrying="";
	public static String codeDomain="";
